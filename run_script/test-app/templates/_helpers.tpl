...
*/}}
{{- define "test-app.batch.labels" -}}
{{ include "test-app.labels" . }}
app.kubernetes.io/component: {{ include "test-app.fullname" . }}-batch
{{- with .Values.batch.labels }}
{{ toYaml . }}
{{- end }}
{{- end }}

{{/*
batch-specific annotations
*/}}
{{- define "test-app.batch.annotations" -}}
{{- with .Values.batch.annotations }}
{{- toYaml . }}
{{- end }}
{{- end }}

{{/*
batch-specific selector labels
*/}}
{{- define "test-app.batch.selectorLabels" -}}
{{ include "test-app.selectorLabels" . }}
app.kubernetes.io/component: {{ include "test-app.fullname" . }}-batch
{{- end }}

{{/*
cron-specific labels
*/}}
{{- define "test-app.cron.labels" -}}
{{ include "test-app.labels" . }}
app.kubernetes.io/component: {{ include "test-app.fullname" . }}-cron
...
{{/*
cron-specific annotations
*/}}
{{- define "test-app.cron.annotations" -}}
...
{{/*
cron-specific selector labels
*/}}
{{- define "test-app.cron.selectorLabels" -}}
{{ include "test-app.selectorLabels" . }}
app.kubernetes.io/component: {{ include "test-app.fullname" . }}-cron
{{- end }}
...
{{/*
fluentdElasticsearch-specific labels
*/}}
{{- define "test-app.fluentdElasticsearch.labels" -}}
{{ include "test-app.labels" . }}
app.kubernetes.io/component: {{ include "test-app.fullname" . }}-fluentdElasticsearch
{{- with .Values.fluentdElasticsearch.labels }}
{{ toYaml . }}
{{- end }}
{{- end }}

{{/*
fluentdElasticsearch-specific annotations
*/}}
{{- define "test-app.fluentdElasticsearch.annotations" -}}
{{- with .Values.fluentdElasticsearch.annotations }}
{{- toYaml . }}
{{- end }}
{{- end }}

{{/*
fluentdElasticsearch-specific selector labels
*/}}
{{- define "test-app.fluentdElasticsearch.selectorLabels" -}}
{{ include "test-app.selectorLabels" . }}
app.kubernetes.io/component: {{ include "test-app.fullname" . }}-fluentdElasticsearch
{{- end }}
