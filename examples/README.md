# Examples
`app` - helm chart generated by helmify from [test_data/sample-app.yaml](https://github.com/danilonicioka/helmify/blob/main/test_data/sample-app.yaml). 
...
`operator` - helm chart generated by helmify from [test_data/k8s-operator-kustomize.output](https://github.com/danilonicioka/helmify/blob/main/test_data/k8s-operator-kustomize.output). 
