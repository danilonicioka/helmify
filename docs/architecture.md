...
- **api/** – Embedded HTTP service exposing `/v1/generate` (which now uses standard extraction with multi-deployment auto-detection) and a web UI wizard for interactive chart creation.
