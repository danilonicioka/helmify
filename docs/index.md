...
- **[Standardized Helm Chart Standard Specification](chart_standard_spec.md)**: Strict specification guide for values structures, naming schemes, component labels, and OpenShift multi-zone Routes.
