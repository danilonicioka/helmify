        function parseComponentConfig(compData) {
            return {
                ...
                probes: compData.probes,
                command: compData.command,
                args: compData.args,
                podSecurityContext: compData.podSecurityContext,
                securityContext: compData.securityContext,
                lifecycle: compData.lifecycle,
                hostAliases: compData.hostAliases,
                topologySpreadConstraints: compData.topologySpreadConstraints,
                priorityClassName: compData.priorityClassName,
                terminationGracePeriodSeconds: compData.terminationGracePeriodSeconds,
                ...
                persistence: {
                    ...
                    ephemeral: !!(compData.persistence && compData.persistence.ephemeral),
                    mountPath: (compData.persistence && compData.persistence.mountPath) || '/var/lib/data',
                    storageRequest: (compData.persistence && compData.persistence.storageRequest) || '1Gi',
                    accessMode: (compData.persistence && compData.persistence.accessMode) || '',
                    storageClass: (compData.persistence && compData.persistence.storageClass) || ''
                },
        ...
        function buildPayload() {
            ...
            const payload = {
                ...
                devRepoUrl: document.getElementById('devRepoUrl').value || `https://${window.ENV?.DevRepo || '{{DEV_REPO}}'}/devops/my-app.git`,
