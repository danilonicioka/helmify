        ...
        function buildPayload() {
            ...
            const payload = {
                ...
                type: chartType,
                devRepoUrl: document.getElementById('devRepoUrl').value || (chartType === 'single' ? 'https://{{DEV_REPO}}/devops/chart-model-app.git' : 'https://{{DEV_REPO}}/devops/chart-model-api.git'),
